...
public class PlayPanel extends JPanel {
	...
	private void initComponents() {
		...
		songName = new JLabel("VAGU Music");

		download = new IconButton("下载", "icon/下载.png");
		mark = new IconButton("我喜欢", "icon/爱心.png");
		share = new IconButton("分享", "icon/分享h.png");

		timerProgressBar = new TimeProgressBar();
		mode = new JComboBox<>();

		backPlay = new IconButton("上一首", "icon/上一首.png");
		play = new IconButton("播放", "icon/播放.png");
		play.setSelectedIcon(new ImageIcon("icon/暂停.png"));
		play.setDisabledSelectedIcon(new ImageIcon("icon/播放.png"));
		play.setMnemonic(KeyEvent.VK_ENTER);

		frontPlay = new IconButton("下一首", "icon/下一首.png");
		voiceControl = new IconButton("静音", "icon/喇叭.png");
		...
		new Thread(
				() -> {
					...
					try {
						...
						JOptionPane.showMessageDialog(null, "下载完成,文件存至F:/music图片",
								"", JOptionPane.PLAIN_MESSAGE);
					} catch (Exception e) {
						e.printStackTrace();
					}
